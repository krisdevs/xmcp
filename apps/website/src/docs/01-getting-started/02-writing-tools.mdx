...
The first thing you may have noticed if you are familiar with MCP is that the syntax for creating a tool differs. This is because the framework uses file system routing. xmcp will automatically handle the server and listing of your tools.
